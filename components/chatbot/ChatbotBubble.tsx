...
export function ChatbotBubble({ onClick, showBadge = true }: ChatbotBubbleProps) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-50 w-[60px] h-[60px] bg-[#1E3A5F] rounded-full shadow-lg flex items-center justify-center hover:bg-[#15294A] transition-colors"
